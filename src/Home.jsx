  ...
  return (
    <body className="h-screen w-screen flex flex-col items-center justify-center bg-bggrad bg-cover bg-no-repeat box-border font-orbitron">
      ...
      >
        <div
          id="logofull"
          className="w-full h-[60%] mt-[5%] flex flex-col items-center justify-start font-audiowide"
        >
          <img
            id="logomed"
            className="h-[70%]"
            src={require("../img/logomed.png")}
            alt="funny medusa logo"
          />
          <div
            id="ashun"
        ...
        <div className="w-[60%] h-[30%] mb-[5%] flex flex-col items-center justify-end">
          <div
            id="inputcontainer"
            className="w-full h-[40%] flex flex-col items-center justify-end"
          >
            <input
              type="text"
              id="myinput"
          ...
          <div
            id="container"
            className="w-full h-[60%] flex flex-col items-center justify-end"
          >
            <div id="btn">
